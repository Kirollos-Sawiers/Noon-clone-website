              ...
              <div className="d-flex align-items-center order-md-1 order-1">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="d-flex ">
                    ...
                    >
                      <div className="d-flex align-items-center">
                        <div className="me-2 ">{t('Deliver_to')}</div>
                  ...
                  <Modal show={showMap} onHide={handleCloseMap} size="lg">
                    ...
                    <Modal.Body>
                      ...
                      {address == null && address == "undefined,undefined" ? (
                        ...
                        <>
                          <div>
                          {t("Current_Address")} "{address}" {t("Click_link")}
                          </div>
                          <button
                            type="button"
              ...
              <LanguageSwitcher />
                ...
                <Link to={"/cart"}>
                  <button class="btn" style={{ border: "none" }}>
                    {" "}
                    {t("Cart")} <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                  </button>
                </Link>
              </div>
            </div>
