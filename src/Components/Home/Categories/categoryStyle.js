    ...
    <>
      <div className="row" style={{ backgroundColor: `${props.color}` }}>
        ...
        <div className=" my-3 d-flex justify-content-between">
          <CategoryStyleComp imgurl={t("electro_img1")} />
          <CategoryStyleComp imgurl={t("electro_img2")} />
          <CategoryStyleComp imgurl={t("electro_img3")} />
          <CategoryStyleComp imgurl={t("electro_img4")} />
          <CategoryStyleComp imgurl={t("electro_img5")} />
          <CategoryStyleComp imgurl={t("electro_img6")} />
          <CategoryStyleComp imgurl={t("electro_img7")} />
        </div>
      </div>
